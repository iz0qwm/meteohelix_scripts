<?php
	...
	#	v3.0 - Apr 24, 2020
	#		- New sea level pressure calcuation: seaLevel = (hPa * pow(1 - (0.0065*altitude) / (bmp.temperature + (0.0065 * altitude) + 273.15),-5.257 ));
	############################################################################
	...
	$altitude = 294; # Altitude of the weather station in meters.
